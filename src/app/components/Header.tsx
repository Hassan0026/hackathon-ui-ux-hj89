          ...
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            />
               ...
               >
                ...
                <div >
                  <h1 className="border-b-black border-b flex items-center gap-1 ">Sign In</h1>
                </div>
                </Link>
               <Link 
               href="/Login"
               ...
               >
                ...
                <div >
                  <h1 className="border-b-black border-b flex items-center gap-1 ">Join Us</h1>
                </div>
                </Link>
                <Link 
                href="/Store"
                ...
                >
                <div >
                  <h1 className="border-b-black border-b flex items-center gap-1">Find a Store</h1>
                </div>
               </Link>
